...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['sdrunet']:
        from data.dataset_sdrunet import DatasetSDRUNet as D
        
    elif dataset_type in ['gdngfnet']:
        from data.dataset_gdngfnet import DatasetGDnGFNet as D
